function [s_est, dap_equalizer_struct] = delay_and_predict_nopar(Y, s_ref, p1, p2, fs, s1_enable, results_dir)
% Run Delay-and-Predict dereverberation without parallelized for loops
% Inputs:
