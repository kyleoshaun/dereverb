...
%\begin{figure}[H]
%	\includegraphics[width=0.98\textwidth]{DAP_EvalT60Sweep_TruncatedSAL_wNoise}
%	\centering
%	\caption{DAP Dereverb Eval, T60 Sweep Truncated SAL with noise}
%	\label{fig:DAP_EvalT60Sweep_TruncatedSAL_wNoise}
%\end{figure}
...
%\begin{figure}[H]
%	\includegraphics[width=0.98\textwidth]{DAP_EvalSNRSweep_TruncatedSAL_NoNoise}
%	\centering
%	\caption{DAP Dereverb Eval, SNR Sweep Truncated SAL no noise}
%	\label{fig:DAP_EvalSNRSweep_TruncatedSAL_NoNoise}
%\end{figure}
