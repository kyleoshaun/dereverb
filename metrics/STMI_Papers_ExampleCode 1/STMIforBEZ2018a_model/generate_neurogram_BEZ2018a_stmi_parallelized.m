function [neurogram_stmi,t_stmi,CFs] = generate_neurogram_BEZ2018a_stmi_parallelized(stim,Fs_stim,species,ag_fs,ag_dbloss)
%GENERATE_NEUROGRAM_BEZ2018_STMI_PARALLELIZED Generate a neurogram with CFs
% and time steps suitable for the STMI speech-intelligibility metric using
% the Matlab Parallel Computation Toolbox, using the auditory periphery
% model of Bruce, Erfani & Zilany (Hear. Res. 2018), including an option to
% use a humanized version of the model.
%
% [NEUROGRAM_STMI,T_STMI,CFS] = GENERATE_NEUROGRAM_BEZ2018_STMI_PARALLELIZED(STIM,FS_STIM,SPECIES,AG_FS,AG_DBLOSS)
%
...
%
% Ian C. Bruce <ibruce@ieee.org> © 2018-21
...
% Run model_IHC_BEZ2018 and model_Synapse_BEZ2018 functions to estimate the
% size of neurogram_ft and other varaibles.  
vihc = model_IHC_BEZ2018a(pin,CFs(1),nrep,1/Fs,simdur,cohcs(1),cihcs(1),species);
...
neurogram_stmi=zeros(numcfs,length(psth_stmi));
clear vihc psth_ft psth_mr
%%
