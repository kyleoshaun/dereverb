...
BIF =([0.0076 0.0108 0.0149 0.0311 0.0573 0.0650 0.0649 0.0532 0.0473 0.0418 0.0380 0.0366 0.0355 0.0385 0.0405 0.0402 0.0397 0.0396 0.0416 0.0424 0.0406 0.0355 0.0280 0.0236 0.0235 0.0195 0.0150 0.0139 0.0610 0.0030]);
...
% ratio = sum(avg_energy(:,1:4),2)./sum(avg_energy(:,5:Kstar),2);
% ratio = sum(ratio.*BIF');
