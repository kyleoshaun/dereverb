function [sii,A,Z] = SII(E,N,T,I,G)
% Function for calculating the SII according to ANSI S3.5-1997
%
% INPUT Variables
%
%  #  name   explanation
%
%  1. E      Speech Spectrum Level (Section 3.6 in the standard)
%  2. N      Equivalent Noise Spectrum Level (Section 3.15 in the standard)
%  3. T      Equivalent Hearing Threshold Level [dBHL] (Section 3.23 in the standard)
%  4. I      Band Importance function (Section 3.1 in the standard)
%  5. G      Insertion Gain [dB] (Section 3.28 in the standard)
%
% OUTPUT Variables
%
%  1. sii    Speech Intelligibility Index
%
%
% USAGE : sii = SII(E,N,T,I,G)
%
...
function freqb = frequency_bands(freqb,I)
