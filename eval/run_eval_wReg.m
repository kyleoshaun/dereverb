function [metrics] = run_eval_wReg(source_data, noise_data, interf_data, fs, N60, s1_enable, s1_on_clean_speech, HL_NH, HL_HI, h_ha_NH, h_ha_HI, results_dir)
...
[s_est, dap_equalizer_struct] = delay_and_predict_wReg(Y, s, p1, p2, fs, s1_enable, s1_on_clean_speech, results_dir);
