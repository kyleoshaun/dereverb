...
results_dir = sprintf("FINAL_RESULTS/EVAL_RealRIRs_reducedERs_s_%s", datetime("today"));
run_num = 1;
while exist(results_dir, 'Dir')
    results_dir = sprintf("FINAL_RESULTS/EVAL_RealRIRs_reducedERs,%s_%d", datetime("today"), run_num);
    run_num = run_num + 1;
end
mkdir(results_dir)
