...
results_dir = sprintf("FINAL_RESULTS/EVAL_SNR_Sweep_truncatedSAL_%.0fmsec_T60_%s_%s", T60*1000, noise_memo, datetime("today"));
run_num = 1;
while exist(results_dir, 'Dir')
results_dir = sprintf("FINAL_RESULTS/EVAL_SNR_Sweep_truncatedSAL_%.0fmsec_T60_%s_%s_%d", T60*1000, noise_memo, datetime("today"), run_num);
    run_num = run_num + 1;
end
mkdir(results_dir)
